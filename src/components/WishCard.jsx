    ...
    return (
        <section id="wishes" className="wish-section section-padding">
            ...
            >
                ...
                <p className="wish-text" style={{ fontSize: '1.2rem', fontStyle: 'italic', marginBottom: '1rem', lineHeight: '1.8' }}>
                    "Five beautiful years down, forever to go. You make marriage look magical. Happy Anniversary, Avi Mama & Sujata Mami!"
                </p>
                <p className="wish-text-marathi-wish" style={{ fontSize: '1.2rem', fontFamily: 'var(--font-marathi)', fontStyle: 'italic', marginBottom: '2rem', lineHeight: '1.8', color: 'var(--color-secondary)' }}>
